...
@mcp.tool()
def spacepilot_generate_video_wan(
    prompt: str,
    model_size: str = "14B",
    seconds: float = 4.0,
    ...
    """
    try:
        from spacepilot.engines import get_video_engine
...
@mcp.tool()
def spacepilot_generate_video_hunyuan(
    prompt: str,
    seconds: float = 4.0,
    image_path: Optional[str] = None,
    resolution: str = "720p",
...
pluto_generate_video_wan = spacepilot_generate_video_wan
pluto_generate_video_hunyuan = spacepilot_generate_video_hunyuan
