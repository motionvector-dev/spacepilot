...
from spacepilot.api.security import LocalOnlyMiddleware
from fastapi.responses import JSONResponse
from fastapi.staticfiles import StaticFiles
from mcp.server.transport_security import TransportSecuritySettings

from spacepilot.core.config import Settings, get_settings
from spacepilot.services.watchdog import idle_watchdog_loop
from spacepilot.api.routes import (
    health_router,
    views_router,
    assets_router,
    compute_router,
