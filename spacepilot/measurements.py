...
from spacepilot.model_registry import SPEED_METRICS, BACKENDS  # noqa: E402
...
# and every `sample_contention()` call (two of which bracket every `spacepilot
...
def revision_for(
    *candidates: Optional[str],
    ...
    try:
        from spacepilot.model_registry import registry as _registry
        reg = _registry()
    except Exception:
        return None
