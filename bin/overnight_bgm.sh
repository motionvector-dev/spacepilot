...
caffeinate -i python3 spacepilot/generate_music_templates.py
caffeinate -i python3 spacepilot/generate_music_templates.py --only contemplative-ambient --force
