...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│ 🎖️ THE SWARM COUNCIL (LONG-LIVED AGENT ROLES)                                │
├─────────────────────────────────────────────────────────────────────────────┤
│ 1. 🧭 CTO & SWARM ORCHESTRATOR (Lead Agent)                                  │
...
├─────────────────────────────────────────────────────────────────────────────┤
│ 2. ⚡ CREATIVE & DIFFUSION ENGINEER (Subagent Lane)                          │
...
├─────────────────────────────────────────────────────────────────────────────┤
│ 3. 🛡️ FLEET, CLOUD & SECURITY ENGINEER (Subagent Lane)                       │
...
├─────────────────────────────────────────────────────────────────────────────┤
│ 4. 🔍 PRINCIPAL CODE REVIEWER & SECURITY AUDITOR (Pro Review Subagent)      │
│    • Focus: Zero-leniency code reviews before ANY merge.                    │
