...
async def main():
    print(f"🚀 SpacePilot Live Voice Bridge running on ws://localhost:8092 (Key auto-loaded from Doppler!)")
    async with websockets.serve(proxy_handler, "localhost", 8092):
