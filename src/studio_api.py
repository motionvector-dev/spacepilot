...
# ─────────────────────────────────────────────────────────────────────────────
# Local Compute Capability & Model Recommender Endpoints
# ─────────────────────────────────────────────────────────────────────────────
...
@app.get("/api/compute/local-profile")
...
@app.get("/api/compute/models/recommended")
...
@app.post("/api/compute/models/download", dependencies=[Depends(require_token)])
...
@app.get("/api/compute/local-status")
